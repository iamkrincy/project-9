...
struct Student s4;
    ...
    printf("____________ Student1____________\n\n ");
	...
	printf("\n");
	printf("____________ Student2____________\n\n ");
	printf("\n");
	...
	printf("\n");
	printf("____________ Student3____________\n\n ");
	printf("\n");
	...
	printf("\n");
	printf("____________ Student4____________\n\n ");
	printf("\n");
	...
	printf("\n");	
    printf("____________ Student5____________\n\n ");
	printf("\n");
	...
	printf("\n");
	printf("\n___________ Student3__________\n");
	printf("\n");
